import HautevilleHouse.AnalyticityContextPdesCanonicalLaneLean.BridgeLemmas
import HautevilleHouse.AnalyticityContextPdesCanonicalLaneLean.GateLemmas
...
theorem conditional_route_source_boundary_carried (A : AdmissibleClass) : ConditionalRouteClosure A -> ClassicalSourceBoundaryCarried := by
  intro h
  exact h.2
